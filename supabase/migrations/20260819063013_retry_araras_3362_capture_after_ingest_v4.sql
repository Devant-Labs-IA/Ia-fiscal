-- Retry the controlled Araras Law 3.362/2001 capture after deploying ingest
-- v4 with governed external-OCR handoff.  This is capture-only: no approval or
...
begin
  ...
  insert into private.knowledge_scheduler_dispatch_events (
    ...
    jsonb_build_object(
      'lease_seconds', 120,
      'attempt', 1,
      'trigger', 'phase2_araras_3362_capture_after_ingest_v4',
